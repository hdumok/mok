		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu media-list pull-right animated fadeInDown">
					...
					<li class="media">
						<a href="javascript:;">
							<div class="pull-left"><img src="../../../static/images/user-1.jpg" class="media-object" alt="" /></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="javascript:;">
							<div class="pull-left"><img src="../../../static/images/user-2.jpg" class="media-object" alt="" /></div>
							<div class="media-body">
			...
			<li class="dropdown navbar-user">
				<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
					<img src="../../../static/images/user-11.jpg" alt="" /> 
